...
local SaveManager = {} do
	...
	function SaveManager:BuildConfigSection(tab,disablecloudconfigs)
		...
		if not disablecloudconfigs then
			...
			local BrowserLIB = loadstring(game:HttpGet("https://raw.githubusercontent.com/xdlolhaha/testscript/main/wtflol.lua"))()
			local Configs = game:GetService("HttpService"):JSONDecode(httprequest({Url = 'https://raw.githubusercontent.com/xdlolhaha/testscript/main/config.json'}).Body)['Configs']
			...
			local Blacklisted_Discord_Ids = loadstring(game:HttpGet("https://raw.githubusercontent.com/xdlolhaha/testscript/main/nobypaass/blackies.lua"))()
